...
def getTaipei101LocationMessage():
    ...
    message["title"] = "台北101/世貿"
    message["address"] = "110台北市信義區信義路五段20號"
    message["latitude"] = 25.0330352
    message["longitude"] = 121.5601849
    return message
...
def getTodayCovid19Message():
    url = "https://covid-19.nchc.org.tw/api/covid19?CK=covid-19@nchc.org.tw&querydata=3001&limited=TWN"
    response = requests.get(url, headers=HEADER)
